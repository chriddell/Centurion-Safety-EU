...
<form action="/" method="GET" class="form form--search form--search--in-header menu--header__item" id="header-search-form">
	...
	<span class="form__input form--search--in-header__input form__input--submit form--search--in-header__input--submit" id="header-pseudo-submit"></span>
	<input class="form__input form--search--in-header__input form__input--submit form--search--in-header__input--submit" type="submit" id="header-search-submit" value="" />
</form>